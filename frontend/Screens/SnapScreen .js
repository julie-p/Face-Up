...
function mapDispatchToProps(dispatch) {
    return {
        onPress: function(imageData) {
            dispatch( {
                type: 'addImage', data: imageData
            })
        }
    }
};

const ReduxSnapScreen = connect(
    null,
    mapDispatchToProps
)(SnapScreen);

export default withNavigationFocus(ReduxSnapScreen);